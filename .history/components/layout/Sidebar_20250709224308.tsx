...
function Sidebar({ isAuthenticated }: SidebarProps) {
  ...
  return (
    <div className="hidden lg:flex flex-col w-72 bg-white shadow-lg fixed left-0 top-0 h-screen z-30">
      <div className="flex flex-col h-full">
        {/* Header - Fixed */}
        <div className="flex items-center justify-center p-6 border-b bg-white flex-shrink-0">
          <Image
